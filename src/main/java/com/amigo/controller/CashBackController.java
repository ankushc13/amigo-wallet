...
import com.amigo.service.CashBackService;
...
public class CashBackController {
	...
	public ResponseEntity<String> getCashBack(@PathVariable String transactionId,@PathVariable String offerCode, HttpServletRequest request) throws CustomerException, JsonProcessingException {
